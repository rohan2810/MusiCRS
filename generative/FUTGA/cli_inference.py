...
parser.add_argument("--whisper_path", type=str, default=os.getenv("WHISPER_PATH", 'generative/SALMONN/whisper-large-v2'))
parser.add_argument("--beats_path", type=str, default=os.getenv("BEATS_PATH", 'generative/SALMONN/BEATs_iter3_plus_AS2M_finetuned_on_AS2M_cpt2.pt'))
parser.add_argument("--vicuna_path", type=str, default=os.getenv("VICUNA_PATH", 'generative/SALMONN-7B/vicuna-7b-v1.5'))
...
def main():
    ...
    modes = ["query_only"]  # Options: ["query_only", "audio_query", "audio_only"]
    num_samples = -1
    ...
    for mode in modes:
        ...
        output_jsonl = os.getenv("FUTGA_OUTPUT", f"generative/results/FUTGA_FINAL/{mode}.jsonl")
