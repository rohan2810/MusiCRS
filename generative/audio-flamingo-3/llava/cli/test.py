...
def main() -> None:
    ...
    parser.add_argument("--model-base", "-m", type=str, default="nvidia/audio-flamingo-3")
    parser.add_argument("--conv-mode", "-c", type=str, default="auto")
    parser.add_argument("--text", type=str, default="what do you hear in the audio?")
    parser.add_argument("--media", type=str, nargs="+", default=None)
    parser.add_argument("--json-mode", action="store_true", default=False)
    parser.add_argument("--think-mode", action="store_true", default=False)
