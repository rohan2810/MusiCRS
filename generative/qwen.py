...
model = Qwen2AudioForConditionalGeneration.from_pretrained(MODEL_ID, device_map="auto", dtype=torch.bfloat16)
model.eval()
...
def main():
    ...
    for mode in modes:
        ...
        output_jsonl = os.getenv("QWEN_AUDIO_OUTPUT", f"generative/results/QWEN_AUDIO_FINAL_FINAL/{mode}.jsonl")
