...
parser.add_argument("--cfg-path", type=str, required=False, default="/home/junda/rohan/reddit-music/generative/SALMONN-7B/configs/decode_config.yaml", help="Path to configuration file")
...
def main():
    ...
    for mode in modes:
        ...
        output_jsonl = f"/home/junda/rohan/reddit-music/generative/results/SALMONN_7B_FINAL/{mode}.jsonl"
