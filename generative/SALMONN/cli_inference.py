...
parser.add_argument("--cfg-path", type=str, required=False, default=os.getenv("SALMONN_CFG", "generative/SALMONN/configs/decode_config.yaml"), help="Path to configuration file")
...
def main():
    ...
    input_jsonl = os.getenv("INPUT_JSONL", "data/merged_final_cleaned_music_clean_queries_with_candidates_enhanced_v2_100_candidates.jsonl")
    ...
    for mode in modes:
        ...
        output_jsonl = os.getenv("SALMONN_OUTPUT", f"generative/results/SALMONN_FINAL/{mode}.jsonl")
